 ...
 *       &lt;sequence>
 *         &lt;element name="currentPageItems" type="{domain.ws.api.contactlab.com}Subscription" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends SlicedDataSet
{
    ...
    protected List<Subscription> currentPageItems;
     ...
     * 
     */
    public List<Subscription> getCurrentPageItems() {
        if (currentPageItems == null) {
            currentPageItems = new ArrayList<Subscription>();
        }
