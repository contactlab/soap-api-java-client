 ...
 *       &lt;sequence>
 *         &lt;element name="currentPageItems" type="{domain.ws.api.contactlab.com}Subscriber" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends SlicedDataSet
{
    ...
    protected List<Subscriber> currentPageItems;
     ...
     * 
     */
    public List<Subscriber> getCurrentPageItems() {
        if (currentPageItems == null) {
            currentPageItems = new ArrayList<Subscriber>();
        }
